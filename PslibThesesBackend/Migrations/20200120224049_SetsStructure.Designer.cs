...
namespace PslibThesesBackend.Migrations
{
    ...
    [Migration("20200120224049_SetsStructure")]
    partial class SetsStructure
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PslibThesesBackend.Models.Work", b =>
                {
                    ...
                    b.Property<int>("MaterialCostsBySchool")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ServicesCostsBySchool")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PslibThesesBackend.Models.WorkGoal", b =>
                {
                    b.HasOne("PslibThesesBackend.Models.Idea", "Work")
                        .WithMany()
                        .HasForeignKey("WorkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PslibThesesBackend.Models.Work", null)
                        .WithMany("Goals")
